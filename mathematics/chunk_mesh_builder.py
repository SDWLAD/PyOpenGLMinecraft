...
@njit(fastmath=True)
def is_void(block_pos, chunk_blocks, chunk_position):
    x, y, z = block_pos
...
@njit(fastmath=True)
def build_chunk_mesh(chunk_blocks, format_size, chunk_position):
    ...
    for x in range(CHUNK_WIDTH):
        for y in range(CHUNK_HEIGHT):
            for z in range(CHUNK_WIDTH):
                ...
                if is_void((x, y + 1, z), chunk_blocks, chunk_position):
                ...
                if is_void((x, y - 1, z), chunk_blocks, chunk_position) and y != 0:
                ...
                if is_void((x + 1, y, z), chunk_blocks, chunk_position):
                ...
                if is_void((x, y, z - 1), chunk_blocks, chunk_position):
